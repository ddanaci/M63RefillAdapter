...
It had to be done.
![Figure02](images/productimage.jpg)
...
The hot glue is a bit too soft, and still remains a bit sticky after cooling - so I dont't recommend this.
...
You can sit it on the end of the refill while you screw on the pen body from above, or you could also tape it to the top of the refill. Don't fully seal the end of the refill, because air needs to get in.
